    ...
    describe '#to_sql' do
      it 'returns SQL equivalent to the update' do
        Timecop.freeze(Time.utc(2001)) do
          ...
          expect(update.to_sql).to eq("UPDATE \"foo_bar\" SET \"document\" = jsonb_set(jsonb_set(\"document\", ARRAY['bar'], '{}'::jsonb, true), ARRAY['bar'], '\"baz\"', true), \"updated_at\" = '2001-01-01 00:00:00.000000+0000' WHERE (\"id\" = '583033a3643431ab5be6ec35')")
        end
      end
      ...
      it 'supports nested field updates' do
        Timecop.freeze(Time.utc(2001)) do
          ...
          expect(update.to_sql).to eq("UPDATE \"foo_bar\" SET \"document\" = jsonb_set(jsonb_set(jsonb_set(\"document\", ARRAY['bar'], '{}'::jsonb, true), ARRAY['bar','baz'], '{}'::jsonb, true), ARRAY['bar','baz'], '\"quux\"', true), \"updated_at\" = '2001-01-01 00:00:00.000000+0000' WHERE (\"id\" = '583033a3643431ab5be6ec35')")
        end
      end
      ...
      it 'supports multiple updates' do
        Timecop.freeze(Time.utc(2001)) do
          ...
          expect(update.to_sql).to eq("UPDATE \"foo_bar\" SET \"document\" = jsonb_set(jsonb_set(jsonb_set(jsonb_set(\"document\", ARRAY['bar'], '{}'::jsonb, true), ARRAY['bar'], '\"baz\"', true), ARRAY['baz'], '{}'::jsonb, true), ARRAY['baz'], '\"quux\"', true), \"updated_at\" = '2001-01-01 00:00:00.000000+0000' WHERE (\"id\" = '583033a3643431ab5be6ec35')")
        end
      end
      ...
      it 'supports setting and unsetting at the same time' do
        Timecop.freeze(Time.utc(2001)) do
          ...
          expect(update.to_sql).to eq("UPDATE \"foo_bar\" SET \"document\" = (jsonb_set(jsonb_set(\"document\", ARRAY['bar'], '{}'::jsonb, true), ARRAY['bar'], '\"quux\"', true) #- ARRAY['baz']), \"updated_at\" = '2001-01-01 00:00:00.000000+0000' WHERE (\"id\" = '583033a3643431ab5be6ec35')")
        end
      end
