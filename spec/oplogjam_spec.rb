...
RSpec.describe Oplogjam do
  describe '.from' do
    it 'converts BSON no-ops into Noop' do
      ...
      expect(described_class.from(bson)).to be_a(Oplogjam::Noop)
    end
    ...
    it 'converts BSON inserts into Inserts' do
      ...
      expect(described_class.from(bson)).to be_a(Oplogjam::Insert)
    end
    ...
    it 'converts BSON updates into Updates' do
      ...
      expect(described_class.from(bson)).to be_a(Oplogjam::Update)
    end
    ...
    it 'converts BSON deletes into Deletes' do
      ...
      expect(described_class.from(bson)).to be_a(Oplogjam::Delete)
    end
    ...
    it 'converts BSON commands into Commands' do
      ...
      expect(described_class.from(bson)).to be_a(Oplogjam::Command)
    end
    ...
    it 'raises an error if given an unknown operation' do
      ...
      expect { described_class.from(bson) }.to raise_error(Oplogjam::UnknownOperation)
    end
  end
end
